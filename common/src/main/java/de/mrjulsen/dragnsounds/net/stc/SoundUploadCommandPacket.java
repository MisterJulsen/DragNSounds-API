                    ...
                    try {                        
                        ...
                        long uploadId = ClientSoundManager.uploadSound(
                            ...
                            (file) -> {
                                ...
                                contextSupplier.get().getPlayer().sendMessage(TextUtils.translate("gui." + DragNSounds.MOD_ID + ".upload.failed").withStyle(ChatFormatting.RED).append(" ").append(e.message()), null);
                                if (Minecraft.getInstance().screen == screen.get()) {
                                    DLScreen.setScreen(null);
                                }
                            }
