...
public class SoundVolumePacket extends BaseNetworkPacket<SoundVolumePacket> {
    ...
    @Override
    public void encode(SoundVolumePacket packet, RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public SoundVolumePacket decode(RegistryFriendlyByteBuf buf) {
