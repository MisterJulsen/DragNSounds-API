...
public class ProgressBarWidget implements Widget {
    ...
    public ProgressBarWidget(int x, int y, int w, int h, double min, double max, double value) {
        this.x = x;
        this.y = y;
        this.width = w;
        this.height = h;
    ...
    public ProgressBarWidget(int x, int y, int w, double min, double max, double value) {
